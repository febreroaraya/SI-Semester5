      ...
      <div class="content">
        ...
        <div class="media">
          <div class="media-left">
            <a href="#">
              <img class="media-object" src="<?= base_url(); ?>assets/frontend/img/products/chrome-book-11.jpg" alt="HP Chromebook 11" />
            </a>
          </div>
        ...
        <div class="media">
          <div class="media-left">
            <a href="#">
              <img class="media-object" src="<?= base_url(); ?>assets/frontend/img/products/chrome-book-14.jpg" alt="HP Chromebook 11" />
            </a>
          </div>
          <div class="media-body">
        ...
        <div class="media">
          ...
          <div class="media-body">
            <h4 class="h4 media-heading">t-shirt</h4>
            <label>kaos</label>
        ...
        <div class="media">
          <div class="media-left">
            <a href="#">
              <img class="media-object" src="<?= base_url(); ?>assets/frontend/img/products/mi-pad-2.jpg" alt="HP Chromebook 11" />
            </a>
          </div>
          <div class="media-body">
            <h4 class="h4 media-heading">t-shirt</h4>
        ...
        <div class="media">
          <div class="media-left">
            <a href="#">
              <img class="media-object" src="<?= base_url(); ?>assets/frontend/img/products/surface-pro.jpg" alt="HP Chromebook 11" />
            </a>
          </div>
          <div class="media-body">
  ...
  <nav class="navbar navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./"> RDPVision </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
            <a href="./store/" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              Lainnya <i class="ion-android-arrow-dropdown"></i>
            </a>
            <ul class="dropdown-menu">
              <li><a href="./store/product.html">Produk</a></li>
