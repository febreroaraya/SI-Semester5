  ...
  <div class="container">
    <div class="row">
        ...
        <div class="carousel-product" data-count="4" data-current="1">
          ...
          <div class="items">
            ...
            <div class="item center" data-marker="1">
              <img src="<?= base_url() ?>assets/frontend/img/product/1.jpg" alt="Microsoft Surface Studio" class="background" />
            </div>

            <div class="item" data-marker="2">
              <img src="<?= base_url() ?>assets/frontend/img/product/2.jpg" alt="Microsoft Surface Studio" class="background" />
            </div>

            <div class="item" data-marker="3">
              <img src="<?= base_url() ?>assets/frontend/img/product/3.jpg" alt="Microsoft Surface Studio" class="background" />
            </div>

            <div class="item" data-marker="4">
              <img src="<?= base_url() ?>assets/frontend/img/product/video.jpg" alt="Microsoft Surface Studio" class="background" />

              <div class="tiles">
                <a href="#video" data-gallery="#video" data-source="youtube" data-id="BzMLA8YIgG0">
                  <img src="<?= base_url() ?>assets/frontend/img/product/video.jpg" alt="Surface Studio">
      ...
      <div class="col-sm-5 col-md-5 no-padding-xs">
        <div class="caption">
          <img src="<?= base_url() ?>assets/frontend/img/brands/microsoft.png" alt="Microsoft" class="brand hidden-xs hidden-sm" />
    ...
    <div class="row">
      <div class="col-sm-7 white sm-padding">
        ...
        <div class="row specification">
          ...
          <div class="col-sm-8">
            <p>NVIDIA GeForce GTX 965M 2GB GPU GDDR5 memory or NVIDIA GeForce GTX 980M 4GB GPU GDDR5 memory</p>
          </div>
        </div>
        ...
        <div class="row specification">
          ...
          <div class="col-sm-8">
            <p>Rapid hybrid drive options: 64GB SSD with 1TB HDD, 128GB SSD with 1TB HDD, 128GB SSD with 2TB HDD</p>
          </div>
        </div>
