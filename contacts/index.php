...
<html lang="en">
  <head>
    ...
    <title> Contact Us &middot; RDPVision &middot; Clothing Brand</title>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="../contacts/index.html">Contacts</a></li>
                </ul>
              </li>
            </ul>
    ...
    <div class="container">
        <div class="row">
          <div class="col-sm-4">
            <div id="Address">
              <address>
                <label class="h3">RDPVision</label><br>
