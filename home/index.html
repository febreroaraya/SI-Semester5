        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="#account"> <i class="ion-android-person"></i> Hello, John </a></li>
      ...
      <div class="carousel" data-count="3" data-current="2">
        ...
        <div class="items">
          <div class="item" data-marker="1">
            <img src="../assets/img/carousel/4.jpg" alt="Background" class="background"/>
          ...
          <div class="item active" data-marker="2">
            <img src="../assets/img/carousel/3.jpg" alt="Background" class="background"/>
          ...
          <div class="item" data-marker="3">
            <img src="../assets/img/carousel/1.jpg" alt="Background" class="background"/>
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-sm-4 align-left">
                        ...
                        <a href="../blog/item-photo.html">More ></a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 align-center">
          <a href="../blog/">
            <img src="../assets/img/tiles/3.jpg" alt="Blog" class="image"/>
          </a>
          <br><br>
        ...
        <div class="col-sm-3 align-center">
          <a href="#video" data-gallery="#video" data-source="vimeo" data-id="110691368" data-id="110691368" data-title="Apple iPad Air" data-description="So capable, you won’t want to put it down. So thin and light, you won’t have to.">
            <img src="../assets/img/tiles/4.jpg" alt="New devices" class="image"/>
          </a>
          <br><br>
        ...
        <div class="col-sm-3 align-center">
          <a href="#video" data-gallery="#video" data-source="youtube" data-id="6g-ZIm0wge4" data-title="Best New Dell Laptops" data-description="Best of dell's laptops that you can consider buying in 2016. 4 Laptops are featured in the video and all of them has equal importance and there is no order that #1 is better than #2">
            <img src="../assets/img/tiles/6.jpg" alt="Del XPS" class="image"/>
          </a>
          <br><br>
        ...
        <div class="col-sm-3 align-center">
          <a href="../blog/">
            <img src="../assets/img/tiles/7.jpg" alt="Gallery" class="image"/>
          </a>
          <br><br>
    ...
    <div class="container">
      ...
      <div class="row products">
        <div class="col-sm-6 col-md-4 product">
          ...
          <a href="./"><img src="../assets/img/products/5.jpg" alt="Surface Pro"/></a>
          ...
          <div class="content">
            ...
            <button class="btn btn-primary btn-rounded btn-sm"> <i class="ion-bag"></i> Tambah Ke Keranjang</button>
          </div>
        </div>

        <div class="col-sm-6 col-md-4 product">
          <a href="#favorites" class="favorites" data-favorite="inactive"><i class="ion-ios-heart-outline"></i></a>
          <a href="./"><img src="../assets/img/products/9.jpg" alt="Lenovo Yoga"/></a>
        ...
        <div class="col-sm-6 col-md-4 product">
          <a href="#favorites" class="favorites" data-favorite="inactive"><i class="ion-ios-heart-outline"></i></a>
          <a href="./"><img src="../assets/img/products/8.jpg" alt="ASUS Transformer"/></a>
        ...
        <div class="col-sm-6 col-md-4 product hidden-md hidden-lg">
          <a href="#favorites" class="favorites" data-favorite="inactive"><i class="ion-ios-heart-outline"></i></a>
          <a href="./"><img src="../assets/img/products/1.jpg" alt="Mi Pad 2/"></a>
    ...
    <div class="container">
      ...
      <div class="row products">
        <div class="col-sm-6 col-md-3 product">
          <a href="#favorites" class="favorites" data-favorite="inactive"><i class="ion-ios-heart-outline"></i></a>
          <a href="./"><img src="../assets/img/products/2.jpg" alt="HP Chromebook 11"/></a>
        ...
        <div class="col-sm-6 col-md-3 product">
          <a href="#favorites" class="favorites" data-favorite="inactive"><i class="ion-ios-heart-outline"></i></a>
          <a href="./"><img src="../assets/img/products/1.jpg" alt="HP Chromebook 14"/></a>
        ...
        <div class="col-sm-6 col-md-3 product">
          <a href="#favorites" class="favorites" data-favorite="inactive"><i class="ion-ios-heart-outline"></i></a>
          <a href="./"><img src="../assets/img/products/10.jpg" alt="HP Chromebook 14"/></a>
