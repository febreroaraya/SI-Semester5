...
<html lang="en">
  <head>
    ...
    <title> HP Chromebook 11 &middot; RDPVision &middot; Clothing Brand</title>
        ...
        <div class="checkout container-fluid">
          <div class="row">
            ...
            <div class="col-xs-6 col-sm-6">
              <a class="btn btn-primary" href="../checkout/index.html"> Checkout order </a>
            </div>
          </div>
        </div>
      </div>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="active"><a href="../catalog/product.html">Product</a></li>
